...
def _circularChladniPattern(m: int, n: int, H: int, tolerance: float) -> list[list[float]]: ...
...
def _rectangularChladniPattern(m: float, n: float, X: int, Y: int, tolerance: float) -> list[list[float]]: ...
